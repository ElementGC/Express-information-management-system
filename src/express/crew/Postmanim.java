...
//快递员信息修改界面
public class Postmanim extends JFrame{
    ...
    String sex = null;
    String postemp = PostmanManage.postemp;
...
//            System.out.println(count);输出的是当前总个数
        ...
        //没有输入时
        if ("".compareTo(postemp) == 0){
            JOptionPane.showMessageDialog(null, "快递员工号为空！请重新输入！",
